...
export default function Footer() {
  return (
    ...
    items-center md:justify-between pt-[18px] md:px-[85px] md:py-[95px]"
      ...
      <div className="relative hidden md:flex flex-col items-center pb-10 text-center">
        <div className="relative flex w-11/12 h-[1px] bg-gray-400 my-6"/>
        <span>© 2023 VetCare. Todos los derechos reservados</span>
      </div>
    </>
  );
}
