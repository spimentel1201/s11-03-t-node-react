...
export default function Contactanos() {
  return (
    <div className="flex flex-col-reverse items-center justify-center xl:flex-row px-10 pb-24 bg-secondary-content">
      ...
      font-normal leading-7 mb-[13px] md:mb-[45px] font-inter"
          ...
          <p
            className="text-center text-slate-600 text-sm md:text-xl
      font-normal leading-7 font-inter"
          >
            Contáctanos hoy mismo y descubre por qué Vet Care es el lugar donde
            el amor por los animales se encuentra con la excelencia en atención
